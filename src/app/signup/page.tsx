    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center px-4 py-12">
      <div className="w-full max-w-5xl grid md:grid-cols-2 bg-white rounded-2xl shadow-2xl overflow-hidden">
        ...
        <div className="bg-black text-white p-10 md:p-16 flex flex-col justify-center">
          ...
          <ul className="mt-10 space-y-4 text-gray-100 text-xs">
        ...
        <div className="p-10 md:p-16">
          <div className="max-w-md mx-auto">
            ...
            <p className="text-xs text-gray-600">
              Get started with Albitros today. No credit card required.
            </p>

            {error && (
              <div className="mt-6 p-4 bg-red-50 border border-red-200 text-red-700 rounded-lg text-xs">
                {error}
              </div>
            )}
            ...
            <form onSubmit={handleSubmit} className="mt-8 space-y-6">
              ...
              <div>
                <label htmlFor="claimsVolume" className="block text-xs font-medium text-gray-700">
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full py-4 bg-black text-white font-semibold rounded-xl hover:bg-gray-900 disabled:opacity-50 disabled:cursor-not-allowed transition text-xs"
              >
